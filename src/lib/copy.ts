...
export const copy = {
  pt: {
    ...
    software: {
      ...
      lead: "Aplicações à medida, portais, integrações e camadas digitais à volta das plataformas que já existem — sem um folheto a fingir de produto.",
      points: [
        "Aplicações web e ferramentas internas",
        "Integração entre sistemas, APIs e dados",
        "Portais de cliente e experiências digitais",
        "Modernização de aplicações que ainda aguentam o negócio",
      ],
    },
    infrastructure: {
      kicker: "Infraestrutura",
      title: "A base em que o resto assenta.",
      lead: "Redes, data centre, storage, cloud híbrida e colaboração. O trabalho que não se vê quando corre bem — e que não pode falhar.",
      points: [
        "Redes e cibersegurança de perímetro",
        "Data centre, storage e infraestrutura convergente",
        "Cloud híbrida e serviços HPE / Aruba",
    ...
    support: {
      ...
      lead: "Manutenção, monitorização e resposta. O site e os sistemas têm de continuar a funcionar depois do go-live.",
      points: [
        "Suporte e manutenção de ambientes",
        "Monitorização e resposta a incidentes",
        "Patches, actualizações e higiene",
  ...
  en: {
    ...
    software: {
      ...
      lead: "Custom applications, portals, integrations and digital layers around platforms that already exist — not a brochure pretending to be a product.",
      points: [
        "Web applications and internal tools",
        "System integration, APIs and data",
        "Customer portals and digital experiences",
        "Modernisation of applications the business still runs on",
      ],
    },
    infrastructure: {
      kicker: "Infrastructure",
      title: "The layer everything else sits on.",
      lead: "Networks, data centre, storage, hybrid cloud and collaboration. The work you do not notice when it holds — and that cannot fail.",
      points: [
        "Networking and perimeter security",
        "Data centre, storage and converged infrastructure",
        "Hybrid cloud and HPE / Aruba services",
    ...
    support: {
      ...
      lead: "Maintenance, monitoring and response. The site and the systems have to keep running after go-live.",
      points: [
        "Environment support and maintenance",
        "Monitoring and incident response",
        "Patches, upgrades and hygiene",
